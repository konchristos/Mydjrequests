...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf_token()) {
        ...
        if ($action === 'save_toggles') {
            ...
            // Product policy: fuzzy enrichment retired for performance.
            $requestFuzzy = '0';
...
<div class="admin-wrap">
    ...
    <div class="perf-card">
        ...
        <form method="POST">
            ...
            <div class="perf-row">
                <label>
                    <input type="checkbox" name="bpm_fuzzy_on_request_enabled" value="1" disabled>
                    Queued fuzzy enrichment for new requests (retired)
                </label>
                <div class="perf-help">Permanently disabled for platform performance. Existing/manual BPM display is unaffected.</div>
            </div>
            ...
            <div class="perf-row">
                ...
                <div class="perf-help">When OFF, access is restricted to admin users and premium-plan DJs only.</div>
            </div>
