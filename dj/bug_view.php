...
if (!$bug || (int)$bug['user_id'] !== (int)$_SESSION['dj_id']) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf_token()) {
        ...
        if ($comment === '') {
            ...
            $bugModel->addComment($bugId, (int)$_SESSION['dj_id'], $comment, false);
...
<div class="card">
    ...
    <?php if ($error): ?>
        <div class="error" style="margin-top:10px;"><?php echo e($error); ?></div>
    <?php endif; ?>
