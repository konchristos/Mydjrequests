...
.section-divider.cue {
    ...
    background: linear-gradient(
        to bottom,
        rgba(13,13,15,0) 0%,
        rgba(13,13,15,0.85) 35%,
        rgba(13,13,15,0.85) 65%,
        rgba(13,13,15,0) 100%
    );
...
<div class="section-divider cue">
    <span>Choose your DJ style</span>
</div>
...
<section class="how-it-works">
    ...
    <p style="color:#777;font-size:13px;margin-bottom:30px;">
...
<section class="features">
    ...
    <div class="feature-grid">
        <div class="feature tile-hover reveal"><h3>🎧 Easy Requests</h3><p>QR & link-based requests.</p></div>
        <div class="feature tile-hover reveal"><h3>💬 Guest Messages</h3><p>Notes, dedications & tips.</p></div>
        <div class="feature tile-hover reveal"><h3>📈 Popularity Tracking</h3><p>See what the crowd wants.</p></div>
        <div class="feature tile-hover reveal"><h3>💵 Tips</h3><p>Optional tipping support.</p></div>
        <div class="feature tile-hover reveal"><h3>🔍 Metadata</h3><p>Future BPM & mood tagging.</p></div>
        <div class="feature tile-hover reveal"><h3>📊 Analytics</h3><p>Understand your crowd.</p></div>
    </div>
</section>
