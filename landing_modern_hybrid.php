...
<head>
    ...
    <title>MyDJRequests | Modern x Cyberpunk Hybrid</title>
    ...
    <style>
        ...
        * {
        ...
        .city-wash {
            ...
            pointer-events: none;
            background:
                radial-gradient(900px 520px at 18% 10%, rgba(76, 17, 110, 0.28), transparent 70%),
                radial-gradient(880px 520px at 84% 16%, rgba(22, 121, 160, 0.24), transparent 72%),
                linear-gradient(180deg, rgba(4, 8, 14, 0.4) 0%, rgba(5, 9, 15, 0.84) 100%);
        }
...
<main>
    ...
    <section class="section city-stage" data-city="0.15">
        <div class="wrap">
    ...
    <section class="section city-stage" data-city="0.24">
        <div class="wrap">
    ...
    <section class="section city-stage" data-city="0.34">
        <div class="wrap">
    ...
    <section class="wrap closing reveal city-stage" data-city="0.46">
